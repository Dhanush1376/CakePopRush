...
pages.forEach(page => {
  const tsxPath = path.join(process.cwd(), 'src', 'pages', 'admin', 'components', page + 'Skeleton.tsx');
  const cssPath = path.join(process.cwd(), 'src', 'pages', 'admin', 'components', page + 'Skeleton.module.css');
